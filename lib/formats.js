...
var androidFormat = {
  writer: function(output) {
    ...
    this.write = function(data, note, program) {
      ...
      root.att('culture', program.language);
      root.att('language', lang.Name);
      root.att('generator', 'langtool-node '+program.version());
      root.att('command', reconstructCommandLine(program));
